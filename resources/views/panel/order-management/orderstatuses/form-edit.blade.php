	...
	<div class="modal-body">
		...
		<div class="form-group">
            ...
            <input type="text" class="form-control number" id="plot" name="plot" max="4" placeholder="1-4" 
              aria-describedby="plot-error" value="{{$orderstatuses->plot}}">
		...
		<div class="form-group">
      		<label class="col-form-label" for="value">*Notification</label>
      			<select id="notification" name="notification" style="width: 100%;" class="form-control" aria-describedby="notification-error" value="{{$orderstatuses->name}}" required>
