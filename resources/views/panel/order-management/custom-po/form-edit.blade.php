...
<form id="jxForm1" novalidate="novalidate" method="POST" action="{{ route('custom-po.update',['id' => $custom->id]) }}" enctype="multipart/form-data">
{{ method_field('PUT') }}
		{{ csrf_field() }}
<div class="container-fluid">
	<div class="animate fadeIn">
								...
								<div class="row">
									<div class="col-md-12">
											...
											<div class="row">
						                        ...
						                        @foreach ($custom->member as $member)
						                        <input type="text" data-phone="{{$member['phone']}}" data-point="{{$member['point']}}" data-email="{{$member['email']}}" value="{{$member['name']}}" selected class="form-control" id="member-email" readonly>
						                        @endforeach
												...
												<div class="input-group">
													...
													<input type="text" value="{{$member['email']}}" class="form-control" id="member-email" readonly>
												</div>
												<label class="col-form-label" for="phone">*Phone</label>
												<div class="input-group">
													<span class="input-group-text"><i class="fa fa-phone" ></i></span>
													<input type="text" value="{{$member['phone']}}" class="form-control" id="member-phone" readonly>
												</div>
													<label class="col-form-label" for="point">*Point</label>
												<div class="input-group">
													<span class="input-group-text"><i class="fa fa-envelope" ></i></span>
													<input type="text" value="{{$member['point']}}" class="form-control" id="member-point" readonly>
												</div>
												</div>
											</div>
									</div>
					...
					<div class="card-body">
						<div class="row">
								...
								<div class="text-center">
									<img class="rounded picturePrev" src="{{(isset($custom->picture)?asset('img/avatars/'.$custom->picture):asset('img/fiture-logo.png'))}}" 
										style="width: 150px; height: 150px;">
								</div>
								<div class="form-group">
									<label class="col-form-label" for="name_product">*Name</label>
									<input type="text" class="form-control" id="name_product" name="name_product" placeholder="Name" value="{{$custom->name_product}}" aria-describedby="name_product-error" readonly="">
								...
								<div class="form-group">
									...
									<textarea id="description_product" name="description_product" class="form-control" placeholder="Default text area" value="{{$custom->description_product}}" aria-describedby="description_product-error" required readonly=""> {{$custom->description_product}} </textarea>
								...
								<div class="form-group">
									...
									<input type="number" class="form-control" id="quantity_product" name="quantity_product" value="{{$custom->quantity_product}}" placeholder="100" aria-describedby="quantity_product-error" readonly="">
		...
		<div class="row">
			<div class="attr-multiselect attr-dropdown form-group col-md-12">
				<div class="card">
					<div class="card-header">
						<i class="fa fa-align-justify"></i> Comment
					</div>
					<div class="card-body">
								...
								<div class="option-card">
									<div class="form-group">
										<div id="comment" class="control-group input-group" style="margin-top:10px">
											<textarea id="comment" name="comment" class="form-control" placeholder="Default text area" aria-describedby="comment-error" required>{{$custom->comment}}</textarea>
