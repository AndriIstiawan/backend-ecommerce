    ...
    <div class="animate fadeIn">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form id="jxForm" novalidate="novalidate" method="POST" action="{{ route('level.update',['id' => $level_detail->id]) }}">
                            <!--start card -->
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" class="id" name="id" value="{{ $level_detail->id }}">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                    <input type="text" class="form-control input-number" id="order" name="order" placeholder="0" aria-describedby="order-error" value="{{ $level_detail->order }}">
                                                    </div>
                                                    <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="key" name="key" placeholder="Key ID" aria-describedby="key-error" value="{{ $level_detail->key_id }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Name" aria-describedby="name-error" value="{{ $level_detail->name }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="parent" class="form-control" style="width: 100% !important;" name="parent">
                                                    ...
                                                    <option value="{{$level['_id']}}" {{ (isset($level_detail->parent[0]['key_id'])? ($level_detail->parent[0]['key_id']==$level['key_id']?'selected':'') :'') }}>{{$level['name']}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control input-number" id="point" name="point" placeholder="Point" aria-describedby="point-error" value="{{ $level_detail->loyalty_point }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control idr-currency" id="hutang" name="hutang" placeholder="Hutang" aria-describedby="hutang-error" value="{{ str_replace(',00','',number_format($level_detail->hutang,2,',','.')) }}">
                                ...
                                <div class="card-footer">
                                    <div class="form-group pull-right">
                                        <button type="submit" class="btn btn-primary" name="signup" value="Sign up">Save Level</button>
