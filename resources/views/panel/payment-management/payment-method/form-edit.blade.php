                    ...
                    <div class="card-body">
                        <div class="tab-content" id="myTab1Content">
                            ...
                            <div class="tab-pane fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="jxForm1" method="POST" enctype="multipart/form-data" action="{{route('payment-method.update',['id' => $payment->id])}}">
                                            {{ method_field('PUT') }}
                                            {{ csrf_field() }}
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="text-center">
                                                        <img class="rounded picturePrev" src="{{ asset('img/payments/'.$payment->image) }}" style="width: 150px; height: 70px;">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Name of Payment or Bank" aria-describedby="name-error" value="{{$payment->name}}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="switch switch-text switch-pill switch-success">
                                                            <input type="checkbox" class="switch-input" id="status" name="status" {{($payment->status == 'on'? 'checked': '')}} tabindex="-1">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="account" name="account" placeholder="Account" aria-describedby="account-error" value="{{$payment->account}}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="accountNumber" name="accountNumber" placeholder="Account Number" aria-describedby="accountNumber-error" value="{{$payment->account_number}}">
