<form id="jxForm" novalidate="novalidate" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="alert alert-success" role="alert">
            <h4 class="alert-heading">Import categories!</h4>
            <p>Before import the category, make sure the category is in accordance with {{env('APP_NAME','FITURE')}} terms and conditions.
            </p>
        </div>
        <div class="form-group">
            <label class="col-form-label" for="name">*Files
                <br>
                <small class="text-muted">Please download form file before import category data.</small>
            </label>
        </div>
        <div class="form-group">
    ...
    <div class="modal-footer">
        <div class="form-group">
            <a class="btn btn-primary" href="{{route('category.index')}}/download-import-form">
    ...
    function save() {
        if ($('#jxForm').valid()){
            ...
            $.ajax({
                ...
                url: "{{ route('category.index') }}/import-data",
                type: 'POST',
                processData: false,
                contentType: false,
