		...
		<div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="jxForm" method="POST" action="{{ route('product.index') }}/import" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <!-- <button type="submit" class="btn btn-success pull-right">Proccess Import Data</button> -->
                        </form>
                    </div>
