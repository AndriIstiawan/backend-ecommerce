                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <select name="brand" class="form-control brand-unit" aria-describedby="brand-error">
                                                ...
                                                <option value="{{$brand->id}}" picture="{{$brand->picture}}">{{$brand->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <center><img class="brand-picture" src="" style="width: 150px; height: 70px; margin-top:5px; display:none;"></center>
                                        </div>
                                    </div>
                                </div>
                            </div>
