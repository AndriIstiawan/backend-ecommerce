                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" placeholder="Title" aria-describedby="title-error" onkeyup="$('#keyID').val(convertToSlug($(this).val()));$('#keyID').valid();">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="keyID" name="keyID" placeholder="Key ID" aria-describedby="keyID-error">
