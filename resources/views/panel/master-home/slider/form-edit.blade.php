        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="jxForm" method="POST" action="{{route('slider.update',['id' => $slider->id])}}" enctype="multipart/form-data">
                            {{ method_field('PUT') }}
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" placeholder="Title" aria-describedby="title-error" value="{{$slider->title}}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="text-center">
                                        <img class="rounded picturePrev" src="{{ asset('img/sliders/'.$slider->image) }}" style="width: 600px; height: 328px;">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="switch switch-text switch-pill switch-success">
                                                <input type="checkbox" class="switch-input" id="redirect" {{$slider->redirect?'checked':''}} name="redirect" tabindex="-1">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="url" name="url" placeholder="http://103.82.241.18/" aria-describedby="url-error" value="{{$slider->url}}">
