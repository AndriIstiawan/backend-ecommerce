                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Name" aria-describedby="name-error" value="{{$user->name}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="username" name="username" placeholder="Username" aria-describedby="username-error" value="{{$user->username}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="email" name="email" placeholder="Email" aria-describedby="email-error" value="{{$user->email}}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="text-center">
                                                        <img class="rounded picturePrev" src="{{(isset($user->picture)?asset('img/avatars/'.$user->picture):asset('img/fiture-logo.png'))}}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 col-form-label">
                                                    ...
                                                    <div class="form-check form-check-inline mr-1">
                                                        <input class="form-check-input" type="checkbox" value="{{$lap['_id']}}" name="access[]" {{ (isset($lap[ 'checked'])?
                                                            'checked': '') }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 col-form-label">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-check form-check-inline mr-1">
                                                                <input class="form-check-input pm-{{$lmp['_id']}}" type="checkbox" value="{{$lmp['_id']}}" name="module[]" {{ (isset($lmp[ 'checked'])?
                                                                    'checked': '') }} data-count="0" onchange="checklistParent($(this))">
                                                                <label class="form-check-label" for="inline-checkbox1">{{$lmp['name']}}</label>
                                                            </div>
                                                            <div class="col-md-12 col-form-label">
                                                                @foreach($lmp['child'] as $lmp2)
                                                                <div class="form-check form-check-inline mr-1">
                                                                    <input class="form-check-input" type="checkbox" value="{{$lmp2['_id']}}" name="module[]" {{ (isset($lmp2[ 'checked'])?
                                                                        'checked': '') }} data-parent="{{$lmp['_id']}}" onchange="checklist($(this))">
    ...
    function act(action) {
        switch (action) {
            case 'continue':
                ...
                break;
            case 'new':
                window.open("{{ route('master-user.create') }}/?edit=user", "_self");
                break;
            case 'exit':
                window.open("{{ route('master-user.index') }}/?edit=user", "_self");
        }
    }
</script>
@endsection