<form id="jxForm" novalidate="novalidate" method="POST" action="{{ route('role.index') }}">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            <label class="col-form-label" for="name">*Name
                <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" data-original-title="Name of Role"></i>
            </label>
