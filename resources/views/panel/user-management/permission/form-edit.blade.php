    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            <label class="col-form-label" for="name">*Name
                <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" data-original-title="Name of Permission"></i>
            </label>
        ...
        <div class="form-group">
            <label class="col-form-label" for="name">*Slug
                <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" data-original-title="Key id for Permission"></i>
            </label>
        ...
        <div class="form-group">
            <label class="col-form-label" for="name">*Type
                <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" data-original-title="Type access Permission"></i>
            </label>
            ...
            <div class="collapse {{($permission->type == 'module-menu'?'show':'')}}" id="collapseE" style="margin-left:30px;">
                <div class="form-group">
                    <label class="col-form-label" for="name">Icon
                        <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" data-original-title="Icon for Module Access"></i>
                    </label>
                    <input type="text" class="form-control" name="icon" placeholder="Icon" value="{{{$permission->icon}}}">
                </div>
                <div class="form-group">
                    <label class="col-form-label" for="name">Parent
                        <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" data-original-title="Target parent for Module Access"></i>
                    </label>
